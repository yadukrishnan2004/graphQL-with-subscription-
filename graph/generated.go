...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.createTodo":
		...
		return e.ComplexityRoot.Mutation.CreateTodo(childComplexity, args["text"].(string)), true
	...
	case "Mutation.updateTodo":
		...
		return e.ComplexityRoot.Mutation.UpdateTodo(childComplexity, args["id"].(string), args["done"].(bool)), true
	...
	case "Subscription.todoAdded":
		if e.ComplexityRoot.Subscription.TodoAdded == nil {
			break
		}

		return e.ComplexityRoot.Subscription.TodoAdded(childComplexity), true
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *model.Todo) graphql.Marshaler {
			return ec.marshalNTodo2ᚖgqlᚋgraphᚋmodelᚐTodo(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Todo) graphql.Marshaler {
			return ec.marshalNTodo2ᚕᚖgqlᚋgraphᚋmodelᚐTodoᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Subscription_todoAdded(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	return graphql.ResolveFieldStream(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Subscription_todoAdded(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Subscription().TodoAdded(ctx)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Todo) graphql.Marshaler {
			return ec.marshalNTodo2ᚖgqlᚋgraphᚋmodelᚐTodo(ctx, selections, v)
...
func (ec *executionContext) _Todo_user(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *model.User) graphql.Marshaler {
			return ec.marshalNUser2ᚖgqlᚋgraphᚋmodelᚐUser(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) marshalNTodo2ᚕᚖgqlᚋgraphᚋmodelᚐTodoᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Todo) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTodo2ᚖgqlᚋgraphᚋmodelᚐTodo(ctx, sel, v[i])
	})
